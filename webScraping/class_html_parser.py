...
class ParsedItem:
    """
    A class to take in an HTML page (or part of it), and
    find properties of an item in it.
    """
    ...
    def rating(self):
        ...
        #this down here is another way of getting the rating classes
        #rating_classes = filter(lambda x: x != 'star-rating', classes)
        return rating_classes[0]



#[ParsedItem(p) for p in soup.find_all('article')]
